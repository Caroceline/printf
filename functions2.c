...
/****************** PRINT POINTER ******************/
/**
 * print_pointer - Prints the value of variable pointer
...
/************************* PRINT NON PRINTABLE *************************/
/**
 * print_non_printable - Prints the ascii codes in hexa of non_printable chars.
 * @types: Lists arguments
 * @buffer: Buffer array to handling prints
